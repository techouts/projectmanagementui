      ...
      try {
        ...
        const mockNotifications: Notification[] = [
          ...
          },
          {
            ...
            message: 'Alex Rodriguez will be available for new projects in 5 days',
            type: 'info',
            read: false,
          ...
          },
          {
            ...
            message: 'Technical specifications document has been uploaded to DataTech project',
            type: 'success',
            read: true,
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 space-y-8">
          ...
          <div className="grid gap-6 grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { 
                title: 'Alerts', 
                value: notifications.filter(n => n.type === 'alert' || n.type === 'warning').length, 
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-2">
                            <h3 className={`font-semibold text-slate-800 ${!notification.read ? 'font-bold' : ''}`}>
                              {notification.title}
                            </h3>
